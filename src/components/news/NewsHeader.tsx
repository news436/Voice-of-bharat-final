...
export const NewsHeader = ({ 
  ...
  return (
    <>
      ...
      {/* Sticky Wrapper for Main Header and Breaking News */}
      <div className="sticky top-0 z-40">
        <div className="bg-white/70 dark:bg-black/80 backdrop-blur-2xl shadow-2xl border-b border-black/10 dark:border-white/10 transition-all font-sans">
          {/* Main Header */}
          <div className="container mx-auto px-4 py-2 flex items-center justify-between md:py-3 gap-2 relative">
              {/* Logo */}
            <Link to="/" className="flex items-center space-x-2 group select-none flex-1">
              <img src="/logo.png" alt="Voice of Bharat Logo" className="h-10 sm:h-12 w-auto" />
              <div className="hidden sm:block">
                <h1 className="text-md sm:text-lg md:text-2xl font-extrabold text-black dark:text-white tracking-tight leading-tight font-sans drop-shadow-sm">Voice Of Bharat</h1>
                <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 font-medium mt-1">भारत की आवाज़</p>
                </div>
              </Link>
              {/* Mobile Title */}
            <div className="flex-1 text-center md:hidden">
                <h1 className="text-lg font-extrabold text-black dark:text-white whitespace-nowrap">{t('site.title')}</h1>
              </div>
            ...
            <div className="flex items-center md:hidden gap-2 flex-1 justify-end">
              <button
                ...
                className="bg-white/80 dark:bg-black/80 backdrop-blur-lg border border-black/10 shadow-lg rounded-full p-2 flex items-center justify-center transition-all hover:scale-110 focus:outline-none focus:ring-2 focus:ring-red-300 dark:focus:ring-red-900"
    ...
    <nav className="hidden md:block border-b border-black/10 bg-white/70 dark:bg-black/70 backdrop-blur-xl shadow-lg relative z-20">
        <div className="container mx-auto px-4">
